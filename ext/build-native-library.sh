...
CMAKE_BUILD_FLAGS="$BUILD_FLAGS -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DCMAKE_ARCHIVE_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY -DCMAKE_LIBRARY_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY -DCMAKE_RUNTIME_OUTPUT_DIRECTORY=$OUTPUT_DIRECTORY"
if [[ $RID == 'win-x64' ]]; then
