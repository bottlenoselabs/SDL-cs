...
// <auto-generated>
//  This code was generated by the following tool on 2023-11-20 02:10:20 GMT+00:00:
//      https://github.com/bottlenoselabs/c2cs (v6.1.4.0)
//
...
public static unsafe partial class SDL
{
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_AcquireVideoCaptureFrame", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_AcquireVideoCaptureFrame(SDL_VideoCaptureDevice* device, SDL_VideoCaptureFrame* frame);
    ...
    public static extern CBool SDL_AudioDevicePaused(SDL_AudioDeviceID dev);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_CloseVideoCapture", CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_CloseVideoCapture(SDL_VideoCaptureDevice* device);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetNumVideoCaptureFormats", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_GetNumVideoCaptureFormats(SDL_VideoCaptureDevice* device);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetNumVideoCaptureFrameSizes", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_GetNumVideoCaptureFrameSizes(SDL_VideoCaptureDevice* device, uint format);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetRWProperties", CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_PropertiesID SDL_GetRWProperties(SDL_RWops* context);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetVideoCaptureDeviceName", CallingConvention = CallingConvention.Cdecl)]
    public static extern CString SDL_GetVideoCaptureDeviceName(SDL_VideoCaptureDeviceID instance_id);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetVideoCaptureDevices", CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_VideoCaptureDeviceID* SDL_GetVideoCaptureDevices(int* count);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetVideoCaptureFormat", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_GetVideoCaptureFormat(SDL_VideoCaptureDevice* device, int index, uint* format);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetVideoCaptureFrameSize", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_GetVideoCaptureFrameSize(SDL_VideoCaptureDevice* device, uint format, int index, int* width, int* height);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetVideoCaptureSpec", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_GetVideoCaptureSpec(SDL_VideoCaptureDevice* device, SDL_VideoCaptureSpec* spec);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetVideoCaptureStatus", CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_VideoCaptureStatus SDL_GetVideoCaptureStatus(SDL_VideoCaptureDevice* device);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_OpenVideoCapture", CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_VideoCaptureDevice* SDL_OpenVideoCapture(SDL_VideoCaptureDeviceID instance_id);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_OpenVideoCaptureWithSpec", CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_VideoCaptureDevice* SDL_OpenVideoCaptureWithSpec(SDL_VideoCaptureDeviceID instance_id, SDL_VideoCaptureSpec* desired, SDL_VideoCaptureSpec* obtained, int allowed_changes);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_RWprintf", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong SDL_RWprintf(SDL_RWops* context, CString fmt);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_RWvprintf", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong SDL_RWvprintf(SDL_RWops* context, CString fmt, void* ap);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_ReleaseVideoCaptureFrame", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_ReleaseVideoCaptureFrame(SDL_VideoCaptureDevice* device, SDL_VideoCaptureFrame* frame);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_SetVideoCaptureSpec", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_SetVideoCaptureSpec(SDL_VideoCaptureDevice* device, SDL_VideoCaptureSpec* desired, SDL_VideoCaptureSpec* obtained, int allowed_changes);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_StartVideoCapture", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_StartVideoCapture(SDL_VideoCaptureDevice* device);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_StopVideoCapture", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_StopVideoCapture(SDL_VideoCaptureDevice* device);
    ...
    [CNode(Kind = "FunctionPointer")]
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_VoidPtr_XEventPtr_CBool
    {
        public delegate* unmanaged<void*, XEvent*, CBool> Pointer;
    }
    ...
    public struct SDL_GamepadBinding
    {
        ...
        public SDL_GamepadBinding_ANONYMOUS_FIELD1 input;

        [FieldOffset(16)] // size = 4
        public SDL_GamepadBindingType outputType;

        [FieldOffset(20)] // size = 12
        public SDL_GamepadBinding_ANONYMOUS_FIELD3 output;
    }

    [CNode(Kind = "Union")]
    [StructLayout(LayoutKind.Explicit, Size = 12, Pack = 4)]
    public struct SDL_GamepadBinding_ANONYMOUS_FIELD1
    {
        [FieldOffset(0)] // size = 4
        public int button;

        [FieldOffset(0)] // size = 12
        public SDL_GamepadBinding_ANONYMOUS_FIELD1_ANONYMOUS_FIELD1 axis;

        [FieldOffset(0)] // size = 8
        public SDL_GamepadBinding_ANONYMOUS_FIELD1_ANONYMOUS_FIELD2 hat;
    }

    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 12, Pack = 4)]
    public struct SDL_GamepadBinding_ANONYMOUS_FIELD1_ANONYMOUS_FIELD1
    {
        [FieldOffset(0)] // size = 4
        public int axis;
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 8, Pack = 4)]
    public struct SDL_GamepadBinding_ANONYMOUS_FIELD1_ANONYMOUS_FIELD2
    {
        [FieldOffset(0)] // size = 4
        public int hat;
    ...
    [CNode(Kind = "Union")]
    [StructLayout(LayoutKind.Explicit, Size = 12, Pack = 4)]
    public struct SDL_GamepadBinding_ANONYMOUS_FIELD3
    {
        [FieldOffset(0)] // size = 4
        public SDL_GamepadButton button;

        [FieldOffset(0)] // size = 12
        public SDL_GamepadBinding_ANONYMOUS_FIELD3_ANONYMOUS_FIELD1 axis;
    }

    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 12, Pack = 4)]
    public struct SDL_GamepadBinding_ANONYMOUS_FIELD3_ANONYMOUS_FIELD1
    {
        [FieldOffset(0)] // size = 4
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 64, Pack = 8)]
    public struct SDL_VideoCaptureFrame
    {
        [FieldOffset(0)] // size = 8
        ...
        public fixed byte _data[24]; // Uint8*[3]

        public readonly Span<nint> data
        {
            get
            {
                fixed (SDL_VideoCaptureFrame* @this = &this)
                {
                    var pointer = &@this->_data[0];
        ...
        [FieldOffset(40)] // size = 12
        public fixed byte _pitch[12]; // int[3]

        public readonly Span<int> pitch
        {
            get
            {
                fixed (SDL_VideoCaptureFrame* @this = &this)
                {
                    var pointer = &@this->_pitch[0];
                    var span = new Span<int>(pointer, 3);
                    return span;
                }
            }
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 12, Pack = 4)]
    public struct SDL_VideoCaptureSpec
    {
        [FieldOffset(0)] // size = 4
        public uint format;
    ...
    public enum SDL_PixelFormatEnum : int
    {
        ...
        SDL_PIXELFORMAT_INDEX2LSB = 303038976,
        SDL_PIXELFORMAT_INDEX2MSB = 304087552,
        SDL_PIXELFORMAT_INDEX4LSB = 319816704,
        SDL_PIXELFORMAT_INDEX4MSB = 320865280,
        SDL_PIXELFORMAT_INDEX8 = 335546369,
        SDL_PIXELFORMAT_RGB332 = 353437697,
        SDL_PIXELFORMAT_XRGB4444 = 370281474,
        SDL_PIXELFORMAT_RGB444 = 370281474,
        SDL_PIXELFORMAT_XBGR4444 = 374475778,
        SDL_PIXELFORMAT_BGR444 = 374475778,
        SDL_PIXELFORMAT_XRGB1555 = 370347778,
        SDL_PIXELFORMAT_RGB555 = 370347778,
        SDL_PIXELFORMAT_XBGR1555 = 374542082,
        SDL_PIXELFORMAT_BGR555 = 374542082,
        SDL_PIXELFORMAT_ARGB4444 = 372379650,
        SDL_PIXELFORMAT_RGBA4444 = 373428226,
        SDL_PIXELFORMAT_ABGR4444 = 376573954,
        SDL_PIXELFORMAT_BGRA4444 = 377622530,
        SDL_PIXELFORMAT_ARGB1555 = 372445186,
        SDL_PIXELFORMAT_RGBA5551 = 373559298,
        SDL_PIXELFORMAT_ABGR1555 = 376639490,
        SDL_PIXELFORMAT_BGRA5551 = 377753602,
        SDL_PIXELFORMAT_RGB565 = 370479106,
        SDL_PIXELFORMAT_BGR565 = 374673410,
        SDL_PIXELFORMAT_RGB24 = 403707907,
        SDL_PIXELFORMAT_BGR24 = 406853635,
        SDL_PIXELFORMAT_XRGB8888 = 387323908,
        SDL_PIXELFORMAT_RGBX8888 = 388372484,
        SDL_PIXELFORMAT_XBGR8888 = 391518212,
        SDL_PIXELFORMAT_BGRX8888 = 392566788,
        SDL_PIXELFORMAT_ARGB8888 = 389423108,
        SDL_PIXELFORMAT_RGBA8888 = 390471684,
        SDL_PIXELFORMAT_ABGR8888 = 393617412,
        SDL_PIXELFORMAT_BGRA8888 = 394665988,
        SDL_PIXELFORMAT_XRGB2101010 = 387391492,
        SDL_PIXELFORMAT_XBGR2101010 = 391585796,
        SDL_PIXELFORMAT_ARGB2101010 = 389488644,
        SDL_PIXELFORMAT_ABGR2101010 = 393682948,
        SDL_PIXELFORMAT_RGBA32 = 393617412,
        SDL_PIXELFORMAT_ARGB32 = 394665988,
        SDL_PIXELFORMAT_BGRA32 = 389423108,
        SDL_PIXELFORMAT_ABGR32 = 390471684,
        SDL_PIXELFORMAT_RGBX32 = 391518212,
        SDL_PIXELFORMAT_XRGB32 = 392566788,
        SDL_PIXELFORMAT_BGRX32 = 387323908,
        SDL_PIXELFORMAT_XBGR32 = 388372484,
    ...
    public enum SDL_PixelType : int
    {
        ...
        SDL_PIXELTYPE_INDEX2 = 2,
        SDL_PIXELTYPE_INDEX4 = 3,
        SDL_PIXELTYPE_INDEX8 = 4,
        SDL_PIXELTYPE_PACKED8 = 5,
        SDL_PIXELTYPE_PACKED16 = 6,
        SDL_PIXELTYPE_PACKED32 = 7,
        SDL_PIXELTYPE_ARRAYU8 = 8,
        SDL_PIXELTYPE_ARRAYU16 = 9,
        SDL_PIXELTYPE_ARRAYU32 = 10,
        SDL_PIXELTYPE_ARRAYF16 = 11,
        SDL_PIXELTYPE_ARRAYF32 = 12
    }
    ...
    [CNode(Kind = "Enum")]
    public enum SDL_VideoCaptureStatus : int
    {
        SDL_VIDEO_CAPTURE_FAIL = -1,
        SDL_VIDEO_CAPTURE_INIT = 0,
        SDL_VIDEO_CAPTURE_STOPPED = 1,
        SDL_VIDEO_CAPTURE_PLAYING = 2
    }
    ...
    [CNode(Kind = "OpaqueType")]
    [StructLayout(LayoutKind.Sequential)]
    public struct SDL_VideoCaptureDevice
    {
    }
    ...
    public struct SDL_AudioPostmixCallback
    {
        ...
        public static implicit operator SDL_AudioPostmixCallback(FnPtr_VoidPtr_SDLAudioSpecPtr_FloatPtr_Int_Void data) => new() { Data = data };
    }
    ...
    public struct SDL_AudioStreamCallback
    {
        ...
        public static implicit operator SDL_AudioStreamCallback(FnPtr_VoidPtr_SDLAudioStreamPtr_Int_Int_Void data) => new() { Data = data };
    }
    ...
    [CNode(Kind = "TypeAlias")]
    [StructLayout(LayoutKind.Explicit, Size = 4, Pack = 4)]
    public struct SDL_VideoCaptureDeviceID
    {
        [FieldOffset(0)]
        public uint Data;

        public static implicit operator uint(SDL_VideoCaptureDeviceID data) => data.Data;
        public static implicit operator SDL_VideoCaptureDeviceID(uint data) => new() { Data = data };
    }
    ...
    {
        [FieldOffset(0)]
        public FnPtr_VoidPtr_XEventPtr_CBool Data;

        public static implicit operator FnPtr_VoidPtr_XEventPtr_CBool(SDL_X11EventHook data) => data.Data;
        public static implicit operator SDL_X11EventHook(FnPtr_VoidPtr_XEventPtr_CBool data) => new() { Data = data };
    }
    ...
    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_F32BE = 37152;

    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_F32LE = 33056;

    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_MASK_BIG_ENDIAN = 4096;

    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_MASK_BITSIZE = 255;

    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_MASK_FLOAT = 256;

    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_MASK_SIGNED = 32768;

    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_S16BE = 36880;

    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_S16LE = 32784;

    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_S32BE = 36896;

    [CNode(Kind = "MacroObject")]
    public const int SDL_AUDIO_S32LE = 32800;
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_ACCELEROMETER_AS_JOYSTICK = (string)"SDL_ACCELEROMETER_AS_JOYSTICK";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_ALLOW_ALT_TAB_WHILE_GRABBED = (string)"SDL_ALLOW_ALT_TAB_WHILE_GRABBED";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_ALLOW_TOPMOST = (string)"SDL_ALLOW_TOPMOST";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_DIRECTINPUT_ENABLED = (string)"SDL_DIRECTINPUT_ENABLED";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_GDK_TEXTINPUT_DEFAULT = (string)"SDL_GDK_TEXTINPUT_DEFAULT";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_GRAB_KEYBOARD = (string)"SDL_GRAB_KEYBOARD";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_JOYSTICK_GAMECUBE_RUMBLE_BRAKE = (string)"SDL_JOYSTICK_GAMECUBE_RUMBLE_BRAKE";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_LINUX_DIGITAL_HATS = (string)"SDL_LINUX_DIGITAL_HATS";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_LINUX_HAT_DEADZONES = (string)"SDL_LINUX_HAT_DEADZONES";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_LINUX_JOYSTICK_CLASSIC = (string)"SDL_LINUX_JOYSTICK_CLASSIC";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_LINUX_JOYSTICK_DEADZONES = (string)"SDL_LINUX_JOYSTICK_DEADZONES";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_PS2_DYNAMIC_VSYNC = (string)"SDL_PS2_DYNAMIC_VSYNC";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_QTWAYLAND_CONTENT_ORIENTATION = (string)"SDL_QTWAYLAND_CONTENT_ORIENTATION";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_QTWAYLAND_WINDOW_FLAGS = (string)"SDL_QTWAYLAND_WINDOW_FLAGS";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_QUIT_ON_LAST_WINDOW_CLOSE = (string)"SDL_QUIT_ON_LAST_WINDOW_CLOSE";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_RENDER_BATCHING = (string)"SDL_RENDER_BATCHING";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_RENDER_OPENGL_SHADERS = (string)"SDL_RENDER_OPENGL_SHADERS";

    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_RENDER_SCALE_QUALITY = (string)"SDL_RENDER_SCALE_QUALITY";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_THREAD_STACK_SIZE = (string)"SDL_THREAD_STACK_SIZE";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_VIDEO_EXTERNAL_CONTEXT = (string)"SDL_VIDEO_EXTERNAL_CONTEXT";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_WINDOWS_DISABLE_THREAD_NAMING = (string)"SDL_WINDOWS_DISABLE_THREAD_NAMING";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_WINDOWS_NO_CLOSE_ON_ALT_F4 = (string)"SDL_WINDOWS_NO_CLOSE_ON_ALT_F4";
    ...
    [CNode(Kind = "MacroObject")]
    public static string SDL_HINT_XINPUT_USE_OLD_JOYSTICK_MAPPING = (string)"SDL_XINPUT_USE_OLD_JOYSTICK_MAPPING";
    ...
    [CNode(Kind = "MacroObject")]
    public const int SDL_VIDEO_CAPTURE_ALLOW_ANY_CHANGE = 1;
