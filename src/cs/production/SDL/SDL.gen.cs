// <auto-generated>
//  This code was generated by the following tool on 2023-05-16 01:02:07 GMT+00:00:
...
public static unsafe partial class SDL
{
    ...
    public static extern int SDL_AddGamepadMapping(CString mappingString);
    ...
    public static extern int SDL_ConvertAudioSamples(SDL_AudioFormat src_format, byte src_channels, int src_rate, byte* src_data, int src_len, SDL_AudioFormat dst_format, byte dst_channels, int dst_rate, byte** dst_data, int* dst_len);
    ...
    public static extern SDL_AudioStream* SDL_CreateAudioStream(SDL_AudioFormat src_format, int src_channels, int src_rate, SDL_AudioFormat dst_format, int dst_channels, int dst_rate);
    ...
    public static extern int SDL_GetAudioStreamFormat(SDL_AudioStream* stream, SDL_AudioFormat* src_format, int* src_channels, int* src_rate, SDL_AudioFormat* dst_format, int* dst_channels, int* dst_rate);
    ...
    public static extern void* SDL_GetClipboardData(ulong* length, CString mime_type);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetClipboardUserdata", CallingConvention = CallingConvention.Cdecl)]
    public static extern void* SDL_GetClipboardUserdata();
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetDefaultAudioInfo", CallingConvention = CallingConvention.Cdecl)]
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetGamepadBindForAxis", CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_GamepadBinding SDL_GetGamepadBindForAxis(SDL_Gamepad* gamepad, SDL_GamepadAxis axis);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetGamepadBindForButton", CallingConvention = CallingConvention.Cdecl)]
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetPath", CallingConvention = CallingConvention.Cdecl)]
    public static extern CString SDL_GetPath(SDL_Folder folder);
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_GetRenderWindowSize", CallingConvention = CallingConvention.Cdecl)]
    ...
    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_PlayAudioDevice", CallingConvention = CallingConvention.Cdecl)]
    ...
    public static extern int SDL_SetAudioStreamFormat(SDL_AudioStream* stream, SDL_AudioFormat src_format, int src_channels, int src_rate, SDL_AudioFormat dst_format, int dst_channels, int dst_rate);

    [CNode(Kind = "Function")]
    [DllImport(LibraryName, EntryPoint = "SDL_SetClipboardData", CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_SetClipboardData(SDL_ClipboardDataCallback callback, ulong mime_count, CString* mime_types, void* userdata);
    ...
    [CNode(Kind = "FunctionPointer")]
    [StructLayout(LayoutKind.Sequential)]
    public struct FnPtr_UlongPtr_CString_VoidPtr_VoidPtr
    {
        public delegate* unmanaged<ulong*, CString, void*, void*> Pointer;
    }
    ...
    [CNode(Kind = "Struct")]
    [StructLayout(LayoutKind.Explicit, Size = 24, Pack = 8)]
    public struct SDL_ClipboardCancelled
    {
        [FieldOffset(0)] // size = 4
        public uint type;
    ...
    public struct SDL_GamepadBinding
    {
        ...
        public SDL_GamepadBinding_ANONYMOUS_FIELD1 value;
    }
    ...
    public enum SDL_EventType : int
    {
        ...
        SDL_EVENT_CLIPBOARD_CANCELLED = 2305,
    ...
    {
        [FieldOffset(0)]
        public FnPtr_UlongPtr_CString_VoidPtr_VoidPtr Data;

        public static implicit operator FnPtr_UlongPtr_CString_VoidPtr_VoidPtr(SDL_ClipboardDataCallback data) => data.Data;
        public static implicit operator SDL_ClipboardDataCallback(FnPtr_UlongPtr_CString_VoidPtr_VoidPtr data) => new() { Data = data };
    }
    ...
    {
        [FieldOffset(0)]
        public SDL_ClipboardCancelled Data;

        public static implicit operator SDL_ClipboardCancelled(SDL_ClipboardEvent data) => data.Data;
        public static implicit operator SDL_ClipboardEvent(SDL_ClipboardCancelled data) => new() { Data = data };
    }
