...
//        https://github.com/lithiumtoast/c2cs (v1.6.26.0)
//
...
public static unsafe partial class SDL
{
    ...
    [DllImport(LibraryName)]
    public static extern ulong SDL_wcslen(CString16U wstr);

    // Function @ SDL_stdinc.h:515:32
    [DllImport(LibraryName)]
    public static extern ulong SDL_wcslcpy(CString16U dst, CString16U src, ulong maxlen);

    // Function @ SDL_stdinc.h:516:32
    [DllImport(LibraryName)]
    public static extern ulong SDL_wcslcat(CString16U dst, CString16U src, ulong maxlen);

    // Function @ SDL_stdinc.h:517:34
    [DllImport(LibraryName)]
    public static extern CString16U SDL_wcsdup(CString16U wstr);

    // Function @ SDL_stdinc.h:518:34
    [DllImport(LibraryName)]
    public static extern CString16U SDL_wcsstr(CString16U haystack, CString16U needle);

    // Function @ SDL_stdinc.h:520:29
    [DllImport(LibraryName)]
    public static extern int SDL_wcscmp(CString16U str1, CString16U str2);

    // Function @ SDL_stdinc.h:521:29
    [DllImport(LibraryName)]
    public static extern int SDL_wcsncmp(CString16U str1, CString16U str2, ulong maxlen);

    // Function @ SDL_stdinc.h:522:29
    [DllImport(LibraryName)]
    public static extern int SDL_wcscasecmp(CString16U str1, CString16U str2);

    // Function @ SDL_stdinc.h:523:29
    [DllImport(LibraryName)]
    public static extern int SDL_wcsncasecmp(CString16U str1, CString16U str2, ulong len);
    ...
    [DllImport(LibraryName)]
    public static extern int SDL_vsscanf(CString8U text, CString8U fmt, nint ap);
    ...
    [DllImport(LibraryName)]
    public static extern int SDL_vsnprintf(CString8U text, ulong maxlen, CString8U fmt, nint ap);

    // Function @ SDL_stdinc.h:563:29
    [DllImport(LibraryName)]
    public static extern int SDL_asprintf(CString8U* strp, CString8U fmt);

    // Function @ SDL_stdinc.h:564:29
    [DllImport(LibraryName)]
    public static extern int SDL_vasprintf(CString8U* strp, CString8U fmt, nint ap);
    ...
    [DllImport(LibraryName)]
    public static extern CString8U SDL_GameControllerGetAppleSFSymbolsNameForButton(SDL_GameController* gamecontroller, SDL_GameControllerButton button);

    // Function @ SDL_gamecontroller.h:990:37
    [DllImport(LibraryName)]
    public static extern CString8U SDL_GameControllerGetAppleSFSymbolsNameForAxis(SDL_GameController* gamecontroller, SDL_GameControllerAxis axis);
    ...
    [DllImport(LibraryName)]
    public static extern SDL_hid_device* SDL_hid_open(ushort vendor_id, ushort product_id, CString16U serial_number);

    // Function @ SDL_hidapi.h:243:42
    [DllImport(LibraryName)]
    public static extern SDL_hid_device* SDL_hid_open_path(CString8U path, int bExclusive);
    ...
    [DllImport(LibraryName)]
    public static extern int SDL_hid_get_manufacturer_string(SDL_hid_device* dev, CString16U @string, ulong maxlen);

    // Function @ SDL_hidapi.h:407:29
    [DllImport(LibraryName)]
    public static extern int SDL_hid_get_product_string(SDL_hid_device* dev, CString16U @string, ulong maxlen);

    // Function @ SDL_hidapi.h:419:29
    [DllImport(LibraryName)]
    public static extern int SDL_hid_get_serial_number_string(SDL_hid_device* dev, CString16U @string, ulong maxlen);

    // Function @ SDL_hidapi.h:432:29
    [DllImport(LibraryName)]
    public static extern int SDL_hid_get_indexed_string(SDL_hid_device* dev, int string_index, CString16U @string, ulong maxlen);
    ...
    public struct SDL_hid_device_info
    {
        ...
        [FieldOffset(16)] // size = 8, padding = 0
        public CString16U serial_number;

        [FieldOffset(24)] // size = 2, padding = 6
        public ushort release_number;

        [FieldOffset(32)] // size = 8, padding = 0
        public CString16U manufacturer_string;

        [FieldOffset(40)] // size = 8, padding = 0
        public CString16U product_string;
