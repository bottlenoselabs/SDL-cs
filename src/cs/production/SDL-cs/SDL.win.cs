...
public static unsafe partial class SDL
{
    ...
    // Function @ SDL_surface.h:637:38 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern SDL_Surface* SDL_ConvertSurfaceFormat(SDL_Surface* src, uint pixel_format, uint flags);

    // Function @ SDL_surface.h:614:38 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern SDL_Surface* SDL_ConvertSurface(SDL_Surface* src, SDL_PixelFormat* fmt, uint flags);

    // Function @ SDL_surface.h:592:38 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern SDL_Surface* SDL_DuplicateSurface(SDL_Surface* surface);

    // Function @ SDL_surface.h:580:30 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern void SDL_GetClipRect(SDL_Surface* surface, SDL_Rect* rect);

    // Function @ SDL_surface.h:563:34 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern CBool SDL_SetClipRect(SDL_Surface* surface, SDL_Rect* rect);

    // Function @ SDL_surface.h:542:29 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern int SDL_GetSurfaceBlendMode(SDL_Surface* surface, SDL_BlendMode* blendMode);

    // Function @ SDL_surface.h:529:29 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern int SDL_SetSurfaceBlendMode(SDL_Surface* surface, SDL_BlendMode blendMode);

    // Function @ SDL_surface.h:512:29 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern int SDL_GetSurfaceAlphaMod(SDL_Surface* surface, byte* alpha);

    // Function @ SDL_surface.h:498:29 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern int SDL_SetSurfaceAlphaMod(SDL_Surface* surface, byte alpha);

    // Function @ SDL_surface.h:478:29 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern int SDL_GetSurfaceColorMod(SDL_Surface* surface, byte* r, byte* g, byte* b);

    // Function @ SDL_surface.h:461:29 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern int SDL_SetSurfaceColorMod(SDL_Surface* surface, byte r, byte g, byte b);

    // Function @ SDL_surface.h:439:29 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern int SDL_GetColorKey(SDL_Surface* surface, uint* key);

    // Function @ SDL_surface.h:421:34 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
    public static extern CBool SDL_HasColorKey(SDL_Surface* surface);

    // Function @ SDL_surface.h:407:29 (D:\a\sdl-cs\sdl-cs\ext\SDL\include\SDL_surface.h)
    [DllImport(LibraryName)]
