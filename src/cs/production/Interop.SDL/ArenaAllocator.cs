...
/// <remarks>
///     <p>
///         The <see cref="ArenaAllocator" /> can be useful in native interoperability situations when you need to
...
///     </p>
/// </remarks>
public sealed unsafe class ArenaAllocator
    : IAllocator, IDisposable
{
    ...
    public nint Allocate(int byteCount)
    {
        ...
        if (Used + byteCount > Capacity)
        {
            throw new InvalidOperationException(
                $"Cannot allocate more than {Capacity} bytes with this instance of {nameof(ArenaAllocator)}.");
        }
