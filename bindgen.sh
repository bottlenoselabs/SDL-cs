...
function bindgen_linux {
    ./C2CS ast -i ./ext/SDL/include/SDL.h -o ./ast/SDL.linux.json -s ./ext/SDL/include -b 64 -g SDL_main.h -d \
...
SDL_DISABLE_PMMINTRIN_H \
    ...
    ./C2CS cs -i ./ast/SDL.linux.json -o ./src/cs/production/SDL-cs/SDL.linux.cs -l "SDL2" -c "SDL" -g SDL_bool -a \
"SDL_bool -> CBool" \
"Uint8 -> byte" \
"Uint16 -> ushort" \
"Uint32 -> uint" \
